...
extern "C" {
BIND_128x2_128(simde_mm_and_si128);
BIND_256x2_256(simde_mm256_and_si256);

BIND_128x2_128(simde_mm_andnot_si128);
BIND_256x2_256(simde_mm256_andnot_si256);

BIND_128x2_128(simde_mm_or_si128);
BIND_256x2_256(simde_mm256_or_si256);

BIND_128x2_128(simde_mm_xor_si128);
BIND_256x2_256(simde_mm256_xor_si256);

BIND_256x2_256(simde_mm256_add_epi8);
BIND_256x2_256(simde_mm256_add_epi16);
BIND_256x2_256(simde_mm256_add_epi32);
BIND_256x2_256(simde_mm256_add_epi64);

BIND_256x2_256(simde_mm256_sub_epi8);
BIND_256x2_256(simde_mm256_sub_epi16);
BIND_256x2_256(simde_mm256_sub_epi32);
BIND_256x2_256(simde_mm256_sub_epi64);

BIND_256x2_256(simde_mm256_mullo_epi16);
